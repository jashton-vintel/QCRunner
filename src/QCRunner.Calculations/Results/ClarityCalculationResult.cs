...
public sealed class ClarityCalculationResult : CalculationResultBase
{
    ...
    public override CalculationType Calculation => CalculationType.Clarity;

    public override string Name => "Clarity [NTU]";
